    ...
    <div className={styles['container']}>
      ...
      >
        <div className={styles['hero-text']}>
          <h1 className={styles['primary-heading']}>Your personal MetaMask AI assistant</h1>
          <p className={styles['subtitle']}>Your foxie AI companion is always here to help make your life easier!</p>
        </div>
